...
class MonteCarloService:
    ...
    def estimate_volatility_from_pair(self, currency_pair: str) -> float:
        ...
        if 'EUR' in pair_upper or 'GBP' in pair_upper or 'JPY' in pair_upper or 'CHF' in pair_upper:
            return 0.08
        elif 'BRL' in pair_upper or 'MXN' in pair_upper or 'ZAR' in pair_upper or 'INR' in pair_upper or 'TRY' in pair_upper:
            return 0.15
        elif 'AUD' in pair_upper or 'NZD' in pair_upper or 'CAD' in pair_upper or 'NOK' in pair_upper:
            return 0.12
        else:
            return 0.10

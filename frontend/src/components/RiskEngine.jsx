// RiskEngine.jsx
// Risk Engine tab — Scenario Analysis (live) + Coming Soon modules with jump nav.
...
const MODULES = [
  ...
  },
  {
    ...
    icon:  '📉',
    desc:  'See which exposures are most vulnerable to rate moves.',
  },
  {
    id:    'cfar',
    label: 'Cash Flow-at-Risk',
    icon:  '💸',
    desc:  'Model worst-case cash positions under stress scenarios.',
  },
  {
    id:    'var',
    label: 'VaR',
    icon:  '📊',
    desc:  'Calculate Value-at-Risk across your portfolio for board reporting.',
  },
  {
    id:    'revenue',
    label: 'Revenue Impact',
    icon:  '📈',
    desc:  'Quantify FX effect on revenues and import/export costs.',
  },
  {
    id:    'optimisation',
    label: 'Hedge Optimisation',
    icon:  '🤖',
    desc:  'AI-generated hedge strategy recommendations across your full portfolio.',
  },
]
        ...
        >
          {m.live ? (
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mb-5">
              ...
              <div className="flex items-center justify-between py-5 px-6 border-b-0">
